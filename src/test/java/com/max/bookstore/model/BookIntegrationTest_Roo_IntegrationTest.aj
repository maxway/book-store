...
privileged aspect BookIntegrationTest_Roo_IntegrationTest {
    ...
    public void BookIntegrationTest.testCountBooks() {
        ...
        long count = com.max.bookstore.model.Book.countBooks();
    ...
    public void BookIntegrationTest.testFindBook() {
        com.max.bookstore.model.Book obj = dod.getRandomBook();
        ...
        obj = com.max.bookstore.model.Book.findBook(id);
    ...
    public void BookIntegrationTest.testFindAllBooks() {
        ...
        java.util.List<com.max.bookstore.model.Book> result = com.max.bookstore.model.Book.findAllBooks();
    ...
    public void BookIntegrationTest.testFindBookEntries() {
        ...
        java.util.List<com.max.bookstore.model.Book> result = com.max.bookstore.model.Book.findBookEntries(0, (int) count);
    ...
    public void BookIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyBook(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.max.bookstore.model.Book merged = (com.max.bookstore.model.Book) obj.merge();
        obj.flush();
    ...
    public void BookIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Book' failed to initialize correctly", dod.getRandomBook());
        com.max.bookstore.model.Book obj = dod.getNewTransientBook(Integer.MAX_VALUE);
    ...
    public void BookIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Book' with identifier '" + id + "'", com.max.bookstore.model.Book.findBook(id));
    }
